<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/kvs.Master" CodeBehind="appstep2.aspx.cs" Inherits="kvs.appstep2" %>
              ...
              <td class="auto-style2" colspan="2">
                ...
                <div class="text-justify" style="font-size:small" id="dvbutton" runat="server">
                    ...
                    <div id="divbtn" runat="server" style="text-align:center">
                        <asp:Button ID="btnagree" runat="server" CssClass="btn btn-lg btn-danger" Text="Submit Step 2" OnClick="btnagree_Click" />
                            <asp:Button ID="btnStep3" runat="server" CssClass="btn btn-md btn-info" Text="Continue To Step 3" OnClick="btnStep3_Click" style="font-weight: bold" /><br />
                    <strong>
