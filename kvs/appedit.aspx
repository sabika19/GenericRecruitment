...
<%@ Page Title="" Language="C#" MasterPageFile="~/kvs.Master" AutoEventWireup="true" CodeBehind="appedit.aspx.cs" Inherits="kvs.appedit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MasterContent" runat="server" onload="noBack();"> 
    ...
    <center>
         ...
         <h4 class="auto-style8"><strong>STEP 1 &amp; 2</strong></h4>
        ...
        <div id="all_form" runat="server">
          <div id="dvcand" style="display:block" runat="server">
              ...
              <asp:HiddenField ID="hdcandid" runat="server" />
                ...
                <td >
                 ...
                 <td >
                     <asp:DropDownList ID="ddlrel" runat="server" class="form-control select2" Width="300px">
                         <asp:ListItem value="0" Text="--Select--"></asp:ListItem>
                         <asp:ListItem value="H" Text="Hindu"></asp:ListItem>
                          <asp:ListItem value="I" Text="Muslim"></asp:ListItem>
                         <asp:ListItem value="C" Text="Christian"></asp:ListItem>
                         <asp:ListItem value="S" Text="Sikh"></asp:ListItem>
                         <asp:ListItem value="J" Text="Jain"></asp:ListItem>
                         <asp:ListItem value="B" Text="Buddh"></asp:ListItem>
                         <asp:ListItem value="O" Text="Others"></asp:ListItem>
                     </asp:DropDownList>
...
<br />
             ...
             <tr>
                ...
                <td >
                   <b><span class="auto-style2">Essential Qualifications:</span></b>
                    <br />
                    <strong>
                    <asp:HyperLink ID="hypessqual" runat="server" NavigateUrl="https://cbseitms.nic.in/kvs_static/KVS/ELIGIBILITY_CRITERIA.pdf" Text="Check Essential Qualification" CssClass="auto-style2" Target="_blank"></asp:HyperLink>
                    </strong>
                    <br />
                   <b> <span class="auto-style2">Desirable Qualifications:</span></b>
                    <br />
                    <strong>
                    <asp:HyperLink ID="hypdes" runat="server" NavigateUrl="https://cbseitms.nic.in/kvs_static/KVS/ELIGIBILITY_CRITERIA.pdf" Text="Check Desirable Qualification" CssClass="auto-style2" Target="_blank"></asp:HyperLink>
                    </strong>
                    <br />
        ...
        <div class="center">
            <img alt="" src="img/loader.gif" />
                    ...
                    <tr><td class="auto-style10">Post Graduation
                      ...
                      <tr><td class="auto-style10">D.Ed/B.El.Ed
                       ...
                       <tr><td class="auto-style10">CTET Paper-I<br />
                          ...
                          Only" ForeColor="Red" Font-Bold="true" ControlToValidate="txtyrctet" ValidationExpression="\d+" ValidationGroup="cadndet"></asp:RegularExpressionValidator><asp:RequiredFieldValidator ID="reqyrctet" runat="server" ForeColor="Red" Font-Bold="true" ErrorMessage="*Required" ControlToValidate="txtyrctet" ValidationGroup="cadndet"></asp:RequiredFieldValidator><asp:CompareValidator ID="CompareEndTodayValidator7" Operator="GreaterThanEqual" Type="String" ControltoValidate="txtyrctet" ErrorMessage="*Invalid due to CTET Validity is 7 years" runat="server" ForeColor="Red" Font-Bold="true" ValidationGroup="cadndet" /></td><td>
                               <asp:TextBox ID="txtctetreg" runat="server" autocomplete="off" class="form-control" MaxLength="20" placeholder="Enter Registration Number(2018 Candidates)" width="300px"></asp:TextBox>
                           </td><td><asp:TextBox ID="txtpercctet" runat="server" class="form-control" width="60px" MaxLength="5" autocomplete="off"></asp:TextBox><asp:RegularExpressionValidator ID="regpercctet" runat="server" ErrorMessage="*Numbers 
                      ...
                      <tr><td class="auto-style10">CTET Paper-II<br />
                           (Enter Marks Obtained For Applying for PRT/TGT Posts)<br />
                          ...
                          Only" ForeColor="Red" Font-Bold="true" ControlToValidate="txtyrctet2" ValidationExpression="\d+" ValidationGroup="cadndet"></asp:RegularExpressionValidator><asp:CompareValidator ID="compctet3" Operator="GreaterThanEqual" Type="String" ControltoValidate="txtyrctet2" ErrorMessage="*Invalid due to CTET Validity is 7 years" runat="server" ForeColor="Red" Font-Bold="true" ValidationGroup="cadndet" /></td><td>
                              <asp:TextBox ID="txtctetreg2" runat="server" autocomplete="off" class="form-control" MaxLength="20" placeholder="Enter Registration Number(2018 Candidates)" width="300px"></asp:TextBox>
                          </td><td><asp:TextBox ID="txtpercctet2" runat="server" class="form-control" width="60px" MaxLength="5" autocomplete="off"></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator14" runat="server" ErrorMessage="*Numbers 
                ...
                <table class="table table-bordered table-hover">
                     <tr>
                         <td colspan="4" class="auto-style13" style="text-align:center;">
                             <strong>PHOTO & SIGNATURE
                         </strong>
                         </td>
                     </tr>
                     <tr>
                         <td>
                          ...
                          <td>
                              <strong><span class="auto-style11">CURRENT PHOTO
                         </span></strong><span class="auto-style2">
                         </td>
                          <td>
                              </span><strong><span class="auto-style11">UPLOAD NEW PHOTO (IF NEEDED)
                         </span></strong>
                         </td>
                         <td></td>
                     </tr>
                ...
                <td class="auto-style2" colspan="1">
                    ...
                    Maximum File Size : 50 KB</font></strong></td>
                           <td  class="auto-style3"><strong><asp:Image ID="candimg" runat="server" /><br class="auto-style2" />
                   </strong>
               </td> 
              ...
              <tr id="trsign" runat="server">
                <td class="auto-style2" colspan="1">
                  ...
                  <td  class="auto-style3"><strong><asp:Image ID="candsign" runat="server" /><br class="auto-style2" />
                   </strong>
               </td> 
    ...
    </script>--%>  <cc3:ToolkitScriptManager ID="ToolkitScriptManager3"  AjaxFrameworkMode="Enabled" runat="server">
</cc3:ToolkitScriptManager>
      <!-- ModalPopupExtender -->
<cc3:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="Panel2" TargetControlID="lnkDummy"
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server" >
        <ContentTemplate>
         <br />
        <br />
   <h4><b> EDITING CAN ONLY BE DONE ONCE. KNIDLY CONFIRM THEN ONLY SUBMIT. </b></h4><br /><br />
 ...
 <table class="table table-bordered table-hover" id="tblpreview" runat="server" >
   ...
   <br />
    <asp:Button ID="btnOk" runat="server" CausesValidation="false" Text="SUBMIT" OnClick="btnOK_Click" CssClass="btn btn-md btn-success" OnClientClick="if(!confirm('DATA ONCE SUBMITTED CANNOT BE CHANGED. CLICK CANCEL TO MAKE CHANGES OR OK TO SUBMIT')) return false;" />
      ...
      &nbsp;
      <asp:Button ID="btnCancel" CausesValidation="false" runat="server" Text="MAKE CHANGES" OnClick="btnCancel_Click" CssClass="btn btn-md btn-danger" />
            <br />
      <asp:Button ID="btnLog" CausesValidation="false" runat="server" Text="Go To Log In" OnClick="btnLog_Click" CssClass="btn btn-md btn-info" />
